...
async def generate_plan(state: AgentState):
    ...
    mode_instructions = (
        "You MUST generate the most common, fundamental, evidence-based activities that occupational and speech therapists use for the child's specific goals (e.g., flashcards, basic sorting, direct imitation, standard routines). Focus on traditional, tried-and-true clinical exercises adapted for home."
